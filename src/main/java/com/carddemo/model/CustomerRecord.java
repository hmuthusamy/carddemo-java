...
/**
 * Java model for COBOL copybook CUSTREC.cpy
 * CUSTOMER-RECORD - Duplicate customer record definition (alternate layout).
 * VSAM KSDS - keyed by CUST-ID (same structure as CVCUS01Y / CustomerData).
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Entity
@Table(name = "customer_rec")
